...
export const AdminProfilePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      {/* Profile Banner */}
      <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-900/90 to-purple-950/40 border border-slate-800 shadow-xl relative flex flex-col sm:flex-row items-center sm:items-start gap-6">
        {/* Avatar */}
        ...
        <div className="space-y-2 text-center sm:text-left flex-1 min-w-0">
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
            ...
            <span className="text-[10px] font-extrabold tracking-wider uppercase px-2.5 py-0.5 rounded-full bg-amber-400/10 text-amber-400 border border-amber-400/20">
              {profile.role || 'ADMIN'}
            </span>
            <span className="text-[10px] font-extrabold tracking-wider uppercase px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl text-xs font-bold bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 transition-colors shrink-0"
        >
      ...
      {isEditingProfile && (
        <form onSubmit={handleUpdateProfile} className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-4">
          <h2 className="text-base font-bold text-white mb-2">Edit Account Information</h2>
          ...
          <div>
            <label className="text-xs font-semibold text-slate-300 block mb-1">Profile Photo Image URL</label>
            <input
              type="text"
      ...
      <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-6">
        <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Update your secret credentials. Passwords are never exposed in cleartext.</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-800/70 border border-slate-700 rounded-xl pl-9 pr-10 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-amber-500"
              />
              <button
                type="button"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-800/70 border border-slate-700 rounded-xl pl-9 pr-3 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-amber-500"
                />
              </div>
            </div>
          </div>
