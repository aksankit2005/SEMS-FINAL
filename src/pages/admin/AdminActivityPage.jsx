    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="p-4 rounded-2xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 space-y-3 shadow-sm transition-colors">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          ...
          >
            <option value="ALL" className="bg-white dark:bg-slate-900">Action Type: All</option>
            ...
            <option value="Announcement Created" className="bg-white dark:bg-slate-900">Announcement Created</option>
            <option value="Result Updated" className="bg-white dark:bg-slate-900">Result Updated</option>
