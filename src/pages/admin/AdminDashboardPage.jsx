...
export const AdminDashboardPage = () => {
  ...
  const statCards = [
    { label: 'Total Registrations', value: stats?.totalRegistrations || 0, icon: ClipboardList, color: 'from-blue-600 to-indigo-600', shadow: 'shadow-blue-500/10', path: '/admin/registrations' },
    ...
    { label: 'Total Games / Sports', value: stats?.totalGames || 12, icon: Trophy, color: 'from-blue-500 to-sky-600', shadow: 'shadow-blue-500/10', path: '/admin/master-data' },
    ...
    { label: 'Pending Results', value: stats?.pendingResults || 0, icon: Clock, color: 'from-blue-600 to-cyan-600', shadow: 'shadow-blue-600/10', path: '/admin/results' },
  ...
  return (
    <div className="space-y-8 animate-fade-in text-slate-900 dark:text-white">
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-2xl bg-gradient-to-r from-blue-500/10 via-blue-500/5 to-slate-50 dark:from-slate-900 dark:via-slate-900/90 dark:to-slate-950 border border-blue-500/20 dark:border-slate-800 text-slate-900 dark:text-white shadow-xs">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-extrabold uppercase tracking-widest px-2.5 py-0.5 rounded-full bg-blue-500/15 text-blue-700 dark:text-blue-400 border border-blue-500/30">
                ...
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-slate-200 dark:bg-slate-800 text-blue-600 dark:text-blue-400 border border-slate-300 dark:border-slate-700">
                        {act.action}
                      </span>
                    </div>
