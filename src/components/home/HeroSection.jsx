...
export const HeroSection = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-slate-900 dark:bg-slate-950 text-white py-16 sm:py-24 transition-colors">
      {/* Background Overlay */}
      <div 
      ...
      />
      {/* Gradients */}
      <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/80 dark:from-slate-950 dark:via-slate-950/80 to-transparent" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        {/* Championship Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/90 border border-slate-700/80 backdrop-blur-md mb-8 shadow-xl animate-float">
          ...
          <span className="text-xs text-slate-300">Jul 28 - Aug 02</span>
        </div>

        {/* Hero Title */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight leading-tight max-w-4xl mx-auto">
          WHERE <span className="bg-gradient-to-r from-blue-400 via-indigo-300 to-orange-400 bg-clip-text text-transparent">LEGENDS</span> ARE BORN.
        </h1>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link
            to="/live"
            className="px-8 py-4 rounded-2xl bg-slate-800/90 hover:bg-slate-800 border border-slate-700/80 text-white font-bold text-base backdrop-blur-md transition flex items-center gap-3 shadow-xl"
          >
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/60 backdrop-blur-md">
            <div className="text-2xl sm:text-3xl font-black text-blue-400">11 Sports</div>
            <div className="text-xs text-slate-400 font-medium">Indoor & Outdoor</div>
          </div>
          <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/60 backdrop-blur-md">
            <div className="text-2xl sm:text-3xl font-black text-emerald-400">₹2.5 Lakhs</div>
            <div className="text-xs text-slate-400 font-medium">Total Cash Prizes</div>
          </div>
          <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/60 backdrop-blur-md">
            <div className="text-2xl sm:text-3xl font-black text-orange-400">60+ Colleges</div>
            <div className="text-xs text-slate-400 font-medium">Participating Squads</div>
          </div>
          <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/60 backdrop-blur-md">
            <div className="text-2xl sm:text-3xl font-black text-rose-400">Real-Time</div>
            <div className="text-xs text-slate-400 font-medium">Live Arena Updates</div>
          </div>
        </div>
