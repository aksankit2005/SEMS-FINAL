  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="bg-white dark:bg-[#0B1120] border border-slate-200 dark:border-slate-800 p-4 rounded-2xl space-y-1 shadow-sm">
          <span className="text-[10px] font-mono font-bold uppercase text-amber-600 dark:text-amber-400">Registered Players</span>
        ...
        <div className="bg-white dark:bg-[#0B1120] border border-slate-200 dark:border-slate-800 p-4 rounded-2xl col-span-2 sm:col-span-1 space-y-1 shadow-sm">
          <span className="text-[10px] font-mono font-bold uppercase text-slate-500 dark:text-slate-400">Registration Revenue</span>
          <p className="text-xl font-black text-purple-600 dark:text-purple-400 truncate">₹{totalRevenue.toLocaleString()}</p>
        </div>
      </div>
