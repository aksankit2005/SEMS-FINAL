  ...
  const handleExportExcel = () => {
    ...
    const excelData = filteredResults.map((r) => {
      ...
      return {
        ...
        'Format': r.format || 'Team Match (6v6)',
        ...
        'Venue / Court': r.tableNumber || r.venue || 'Volleyball Court 1',
    ...
    addToast(`Exported ${filteredResults.length} volleyball match results to Excel/CSV!`, 'success');
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200 dark:border-slate-800">
          <div>
            <h3 className="text-lg font-black text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
              ...
              <span>Volleyball Results & Winner Management</span>
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 font-mono mt-0.5">
              Showing {filteredResults.length} of {resultsList.length} completed volleyball matches
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {resultsList.length > 0 && (
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-rose-50 dark:bg-rose-600/20 hover:bg-rose-100 dark:hover:bg-rose-600 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-500/30 text-xs font-bold transition flex items-center gap-1.5 cursor-pointer"
              >
                  ...
                  <tr key={r.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition">
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          onClick={() => generateMatchResultPDF(r, 'Volleyball')}
