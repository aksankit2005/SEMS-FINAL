...
export const TugOfWarMatchScheduleTab = ({ matches, user, onUpdateMatches, globalSearch }) => {
  ...
  const [form, setForm] = useState({
    ...
    team1: '', // Team 1 Name
    team2: '', // Team 2 Name
    tableNumber: 'Tug of War Ground 1', // Ground 1 to 4
  ...
  const handleAddSlot = async (e) => {
    ...
    if (editingId) {
      ...
      const newSlot = {
        id: `M-TOW-${Math.floor(100000 + Math.random() * 900000)}`,
        sport: 'tug-of-war',
        sportId: 'tug-of-war',
      ...
      <div className="lg:col-span-4 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider">
            {editingId ? 'Edit Tug of War Fixture' : 'Add Tug of War Match Fixture'}
          </h3>
          <button
          ...
          <form onSubmit={handleAddSlot} className="space-y-4">
            ...
            <div>
              ...
              {createdEvents.length > 0 ? (
                ...
                <input
                  ...
                  value={form.eventTitle}
                  onChange={(e) => setForm({ ...form, eventTitle: e.target.value })}
                  placeholder="e.g. Tug of War Championship 2026"
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="e.g. Pullers, Titans, Strongholds"
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="e.g. Warriors, Anchors, Force"
                className="w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-[#0B1120] border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
            </div>
              ...
              >
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 font-mono">
                    📍 {displayVenue} | Date: {m.date || '2026-08-05'} | Time: {m.time || '04:00 PM'} | Event: {m.eventTitle || 'Tug of War Championship'}
                  </p>
                </div>
