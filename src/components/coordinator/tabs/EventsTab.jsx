...
5. College ID card must be presented prior to match time.` : 'Official tournament rules apply.\nCollege Student ID & Pass mandatory.');
  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 top-0 left-0 w-full h-full min-h-screen z-[9999] flex items-center justify-center p-3 sm:p-6 bg-slate-950/95 dark:bg-[#090D16]/95 backdrop-blur-md overflow-y-auto font-sans animate-fade-in">
          <div className="w-[95%] sm:w-[85%] lg:w-[75%] max-w-4xl bg-white dark:bg-[#0B1120] text-slate-900 dark:text-white rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-2xl space-y-6 my-auto max-h-[88vh] overflow-y-auto custom-scrollbar">
