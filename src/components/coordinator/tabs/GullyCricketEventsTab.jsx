...
export const GullyCricketEventsTab = ({ user }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans">
      ...
      {/* Create / Edit Modal */}
      {showCreateModal && (
        <div className="fixed inset-0 top-0 left-0 w-full h-full min-h-screen z-[9999] flex items-center justify-center p-3 sm:p-6 bg-slate-950/95 dark:bg-[#090D16]/95 backdrop-blur-md overflow-y-auto animate-fade-in">
          <div className="w-[95%] sm:w-[85%] lg:w-[75%] max-w-4xl bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden my-auto max-h-[88vh] flex flex-col">
