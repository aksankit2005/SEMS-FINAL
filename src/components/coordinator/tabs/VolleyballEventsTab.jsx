...
export const VolleyballEventsTab = ({ user }) => {
  ...
  // Form State specifically for Volleyball (Team Fee only, Min 6 & Max 12 players)
  ...
  const handleOpenEdit = (eventObj) => {
    ...
    setFormData({
      ...
      sportName: 'Volleyball',
      coverImage: eventObj.coverImage || 'https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?auto=format&fit=crop&w=800&q=80',
  ...
  const handleOpenCreate = () => {
    ...
    setFormData({
      title: 'Inter-College Volleyball Championship 2026',
      sportName: 'Volleyball',
      coverImage: 'https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?auto=format&fit=crop&w=800&q=80',
  ...
  const handleCropComplete = (croppedDataUrl) => {
    ...
    addToast('Volleyball cover banner cropped and attached successfully!', 'success');
  };
  ...
  const handleDeleteEvent = async (id, title) => {
    if (window.confirm(`Are you sure you want to delete volleyball event "${title}"?`)) {
      try {
  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans">
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="py-16 text-center space-y-3 bg-white dark:bg-[#0B1120] rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-soft dark:shadow-md">
            ...
            <h3 className="text-base font-black text-slate-900 dark:text-white">No Volleyball Events Created Yet</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 max-w-md mx-auto">
              Click the "Create Volleyball Event" button above to publish your first team registration event for Volleyball.
            </p>
            <button
              onClick={handleOpenCreate}
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-44 w-full bg-slate-900 overflow-hidden">
                    <img
                      src={event.coverImage || 'https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?auto=format&fit=crop&w=800&q=80'}
                      alt={event.title}
      ...
      {/* CREATE / EDIT VOLLEYBALL EVENT MODAL */}
      {showCreateModal && (
            ...
            <form onSubmit={handleSaveEvent} className="space-y-5">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="e.g. Volleyball Arena Court 1"
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => {
                    ...
                    exportToCSV(csvData, `Volleyball_Participants_${selectedEventForParticipants.id}`);
                    addToast('Exported Volleyball Roster as CSV/Excel', 'success');
                  }}
                  ...
                  {filteredParticipants.length === 0 ? (
                    ...
                    filteredParticipants.map((p) => (
                      <tr key={p.id} className="hover:bg-slate-50 dark:hover:bg-slate-900/50 transition">
                        ...
                        <td className="p-3 font-mono">6-12 Players</td>
